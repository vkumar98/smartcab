...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing :
            ...
            #self.epsilon =1/(self.trail*self.trail)
    ...
    def get_maxQ(self, state):
        ...
        for action in self.Q[state]:
             ...
             if maxQValue<qvalue:
                 ...
                 maxQ[:]=''
                 maxQ.append(action)
             elif maxQValue==qvalue: # for same rewards
                 maxQ.append(action)
    ...
    def learn(self, state, action, reward):
        ...
        # Source for learning function: https://en.wikipedia.org/wiki/Q-learning
...
def run():
    ...
    agent = env.create_agent(LearningAgent,learning=True,alpha=0.5,epsilon=4)
